...
def path_to_repo(*args): # REPO/arg1/arg2/arg3/arg4
    return os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__))))), *args)
